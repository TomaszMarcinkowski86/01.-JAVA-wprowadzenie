package pl.sda.java.Day6.Task.files;
...
public class Main {
    public static void main(String[] args) {
        ...
        String pathname = "src//pl/sda/resources/exampleFile.txt";
//        String pathname = "c:/Programowanie/JavaTraining/src/main/resources/exampleFile.txt"; // jest możliwość podania pełnej ścieżki, ale nie zadziała na innym komputerze
        ...
        Path path0 = Paths.get("src/p/sda/resources/exampleFile.txt"); // Tworzenie ścieżki do pliku
        Path path1 = Paths.get("src", "pl","sda", "resources", "exampleFile.txt"); // To samo co wyżej, ale nie martwimy się o obsługę ścieżki przez system operacyjny
